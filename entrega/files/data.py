...
#rating matrix
U,J = get_rating_matrix('r1.train','r1.test',index_users,index_movies,'::')

print "get relevance matrix"
#relevance matrix
G = get_relevance_matrix('tag-genome/tag_relevance.dat',index_movies,index_tags,'\t')
...
print "i",i
#preference matrix
#this generate a preference matrix used by construct T matrix
...
#write predicted and real values in one file
write_predicted('r1.test','predicted'+str(i)+'.txt')
